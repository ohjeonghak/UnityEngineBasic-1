namespace MultiThread_Cafe
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            barista1.IsBackground = true; // Main Thread 끝나면 같이 종료
            barista1.Start(2);
            ...
            barista2.IsBackground = true; // Main Thread 끝나면 같이 종료
            barista2.Start(3);

            Thread barista3 = new Thread(RoastCoffeeBeans);
            barista3.Name = "Barista Choi";
            barista3.IsBackground = true; // Main Thread 끝나면 같이 종료
            barista3.Start(4);

            Thread barista4 = new Thread(RoastCoffeeBeans);
            barista4.Name = "Barista Park";
            barista4.IsBackground = true; // Main Thread 끝나면 같이 종료
            barista4.Start(2);
