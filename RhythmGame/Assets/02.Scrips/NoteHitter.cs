...
{
    public const float HIT_JUDE_RANGE_COOL = 0.4f;
    public const float HIT_JUDE_RANGE_GREAT = 1.0f;
    public const float HIT_JUDE_RANGE_GOOD = 1.8f;
    public const float HIT_JUDE_RANGE_MISS = 3.0f;
